...
export const CHAT_HEADER: string = `Recent Graduate Financial Advisor`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI by Connor Brennan (UNC '25)`;
export const CLEAR_BUTTON_TEXT: string = `Clear Chat`;
export const PAGE_TITLE: string = `Recent Graduate Financial Advisor`;
